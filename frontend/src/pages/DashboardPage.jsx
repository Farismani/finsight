  ...
  const kpis = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        accent: 'bg-blue-500', // ✅ FIXED (was sky)
      },
    ]
  }, [dashboard])

  if (loading) {
    return <div className="glass-panel p-6 text-white/70">Loading dashboard analytics...</div>
  }

  if (error) {
    return <div className="glass-panel p-6 text-red-400">{error}</div>
  }
